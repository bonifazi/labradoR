...
| Year | Sires_unused | Sires_fathers | Dams_unused | Dams_mothers | Total_unused | Total_parents |
|-----:|-------------:|--------------:|------------:|-------------:|-------------:|--------------:|
...
| Year | average_generation_equivalent | perc_of_animals_with_1_generations_in_pedigree_completely_known | perc_of_animals_with_2_generations_in_pedigree_completely_known | perc_of_animals_with_3_generations_in_pedigree_completely_known | perc_of_animals_with_4_generations_in_pedigree_completely_known | perc_of_animals_with\_\>=5_generations_in_pedigree_completely_known |
|-----:|------------------------------:|----------------------------------------------------------------:|----------------------------------------------------------------:|----------------------------------------------------------------:|----------------------------------------------------------------:|--------------------------------------------------------------------:|
