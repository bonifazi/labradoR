...
-   skip empty intervals (NA can be ignored/removed by default, e.g. FRA pops)

-   See if any other plot is needed (see FRA output in PDF here "WLR\\Rumigen\\Results_partners\\Abondance"
